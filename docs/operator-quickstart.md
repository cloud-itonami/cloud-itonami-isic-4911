# Operator Quickstart — Community Passenger Rail Transport

Shortest path from clone to a verified local dry-run for **ISIC 4911** (`cloud-itonami-isic-4911`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-4911.git
cd cloud-itonami-isic-4911
```
...
- Blueprint governor key: `rail-safety-governor`
- Likely source path: `src/**/rail-safety-governor.cljc`
